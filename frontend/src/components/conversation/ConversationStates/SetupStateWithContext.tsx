...
import { useContextState, useConversationActions } from '@/contexts/ConversationContext';

export const SetupStateWithContext: React.FC = () => {
  const context = useContextState();
  const actions = useConversationActions();

  const handleGetReady = () => {
    // Context already handles text context internally
