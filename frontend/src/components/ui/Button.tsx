...
export const Button: React.FC<ButtonProps> = ({
  ...
  const variants = {
    primary: 'bg-app-primary hover:bg-app-primary-dark text-white dark:text-background border-transparent',
  ...
  // Build className in a consistent order
  const baseClasses = 'inline-flex items-center justify-center font-medium rounded-lg border transition-colors duration-200 focus:outline-none focus:ring-2 focus:ring-app-primary focus:ring-offset-2 focus:ring-offset-background';
