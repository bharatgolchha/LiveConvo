  ...
  const meetings = [
    {
      ...
      participants: ['John Doe', 'Sarah Johnson', 'Mike Rodriguez'],
    ...
    },
    {
      ...
      participants: ['Sarah Johnson', 'Tom Wilson', 'Emily Parker', 'Alex Chen'],
    ...
    },
    {
      ...
      participants: ['Mike Rodriguez', 'Client Team'],
    ...
    },
    {
      ...
      participants: ['Emily Parker', 'John Doe', 'Board Members', 'Executive Team', 'Department Heads'],
      status: 'Done' as const,
