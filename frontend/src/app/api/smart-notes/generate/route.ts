...
${getCurrentDateContext()}
            ...
            Guidelines:
            - Extract clear, actionable insights that can be tracked
            - Each note should be concise (max 100 characters)
            - Focus on specific actions, decisions, or key information
            - Include relevant details (e.g., names, timeframes) when mentioned
            - Prioritize notes based on importance and urgency
